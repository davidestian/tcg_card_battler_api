...
type TeamRepository interface {
	...
	InsertPlayerTeam(ctx context.Context, accountID, teamName, playerUnitID1, playerUnitID2, PlayerUnitID3, isActive string) error
...
func (r *teamRepositoryImpl) exec(ctx context.Context) DBQuerier {
...
func (r *teamRepositoryImpl) InsertPlayerTeam(ctx context.Context, accountID, teamName, playerUnitID1, playerUnitID2, PlayerUnitID3, isActive string) error {
	query := `
		INSERT INTO player_teams(account_id, team_name, player_unit_id_1, player_unit_id_2, player_unit_id_3, is_active)
		VALUES ($1, $2, $3, $4, $5, $6)`

	_, err := r.exec(ctx).Exec(ctx, query, accountID, teamName, playerUnitID1, playerUnitID2, PlayerUnitID3, isActive)
	if err != nil {
		return err
	}
	return nil
